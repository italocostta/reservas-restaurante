                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/reservation.TableAvailability"
                            }
                        }
                    },
                    "400": {
                        "description": "date ausente ou malformado",
                        "schema": {
        ...
        "/notifications": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filtra por status (pending, sending, sent, failed). Omitido = failed",
                        "name": "status",
                        "in": "query"
                    }
                ],
        ...
        "/service-exceptions/{day}": {
            "delete": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "Remover a exceção re-fecharia o dia, que tem reservas confirmadas",
                        "schema": {
                            "$ref": "#/definitions/httpx.ErrorResponse"
                        }
                    }
        ...
        "/tables/{id}": {
            ...
            "patch": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "Já existe mesa com o novo nome, ou a mesa tem reservas confirmadas e não pode ser desativada",
                        "schema": {
                            "$ref": "#/definitions/httpx.ErrorResponse"
                        }
                    }
        ...
        "notification.NotificationView": {
            ...
            "properties": {
                ...
                "kind": {
                    "allOf": [
                        {
                            "$ref": "#/definitions/notification.Kind"
                        }
                    ],
